...
public class CertificadoActual extends SherlockActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String ruta = getDir(RUTA_CERT, MODE_PRIVATE).getAbsolutePath() + "/";
            FileInputStream fis = new FileInputStream(new File(ruta + nombre));
            ...
            try {
                ...
                issuerNombre = issuerNombre.substring(issuerNombre.indexOf("L"),
                        issuerNombre.length());
                String ciudad = issuerNombre.substring(issuerNombre.indexOf("L") + 2,
                        issuerNombre.indexOf(","));
                issuerNombre = issuerNombre.substring(issuerNombre.indexOf("O"),
                        issuerNombre.length());
                String org = issuerNombre.substring(issuerNombre.indexOf("O") + 2,
                        issuerNombre.indexOf(","));
                issuerNombre = issuerNombre.substring(issuerNombre.indexOf("CN"),
                        issuerNombre.length());
                String cn = issuerNombre.substring(issuerNombre.indexOf("CN") + 3,
                        issuerNombre.length());
